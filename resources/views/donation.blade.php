            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="relative">
                    ...
                    <div class="relative p-8 md:p-10 h-full flex flex-col justify-between">
                        <div>
                            <span class="bg-yellow-500 text-black px-4 py-1 rounded-full text-sm font-bold">Donate Now</span>
                ...
                <div class="p-8 md:p-10 bg-gray-800">
                    <h2 class="text-2xl font-semibold text-white mb-6">Make Your Donation</h2>
                    ...
                    <form action="{{ route('donate') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-4">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="anonymous" id="anonymous" class="mr-2 h-4 w-4 rounded bg-gray-700 border-gray-600 text-yellow-500 focus:ring-yellow-500 focus:ring-offset-gray-800">
                                        <label for="anonymous" class="text-sm text-gray-400">Donate Anonymously</label>
                                    </div>
                                </div>
                                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="John Doe"
                                    class="w-full p-3 rounded-lg bg-gray-700 text-white border border-gray-600 focus:outline-none focus:border-yellow-500">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="phone" id="phone" value="{{ old('phone') }}" placeholder="Your phone number"
                                        class="w-full p-3 rounded-lg bg-gray-700 text-white border border-gray-600 focus:outline-none focus:border-yellow-500">
                                </div>
                            </div>
                        ...
                        <!-- Payment Method -->
                        <div class="mb-6">
                            <h3 class="text-lg font-medium text-white mb-3">Payment Method</h3>
                            
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                @if($paymentMethods->enable_fib ?? true)
                                <div>
                                    <label class="flex items-center p-4 rounded-lg border border-gray-600 hover:border-yellow-500 cursor-pointer transition-colors">
                                        <input type="radio" name="payment_method" value="fib" checked
                                            class="h-4 w-4 text-yellow-500 focus:ring-yellow-500 focus:ring-offset-gray-800 bg-gray-700 border-gray-600">
                                        <div class="ml-3">
                                            <span class="text-white font-medium">FIB Bank</span>
                                            <p class="text-sm text-gray-400">Pay using secure bank transfer</p>
                                        </div>
                                    </label>
                                </div>
                                @endif
                                
                                @if($paymentMethods->enable_fastpay ?? true)
                                <div>
                                    <label class="flex items-center p-4 rounded-lg border border-gray-600 hover:border-yellow-500 cursor-pointer transition-colors">
                                        <input type="radio" name="payment_method" value="fastpay" {{ $paymentMethods->enable_fib ? '' : 'checked' }}
                                            class="h-4 w-4 text-yellow-500 focus:ring-yellow-500 focus:ring-offset-gray-800 bg-gray-700 border-gray-600">
                                        <div class="ml-3">
                                            <span class="text-white font-medium">FastPay</span>
                                            <p class="text-sm text-gray-400">Pay using mobile payment</p>
                                        </div>
                                    </label>
                                </div>
                                @endif
